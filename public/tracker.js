...
(function() {
  ...
  var HOSTS = ["agency-genesis.psyverse.fun","agents.psyverse.fun","agi.psyverse.fun","aha.psyverse.fun","ai-replacement-map.psyverse.fun","ai-scientist-lab.psyverse.fun","ai-society-sandbox.psyverse.fun","ai-universe.psyverse.fun","aiapps.psyverse.fun","aitools.psyverse.fun","apes.psyverse.fun","apis.psyverse.fun","architect.psyverse.fun","arena.psyverse.fun","atlas.psyverse.fun","attention.psyverse.fun","attraction-lab.psyverse.fun","autonomous-software-civilization.psyverse.fun","autoresearch.psyverse.fun","av.psyverse.fun","awaken-os.psyverse.fun","beyond-matter.psyverse.fun","blockchain-atlas.psyverse.fun","blog.psyverse.fun","brain-computer-interface-world.psyverse.fun","brain.psyverse.fun","chain.psyverse.fun","chainmind.psyverse.fun","chains.psyverse.fun","chaos-os.psyverse.fun","chaos-simulator.psyverse.fun","china-regional-systems.psyverse.fun","chip-war-atlas.psyverse.fun","chrono-void.psyverse.fun","civilization-os-infinity.psyverse.fun","civilization-os.psyverse.fun","civilization-stack.psyverse.fun","civilization-tech-tree.psyverse.fun","civilization-tree.psyverse.fun","civilization-waves.psyverse.fun","civilizations.psyverse.fun","civlab-ai-replacement-map.psyverse.fun","civlab.psyverse.fun","civos-civilization-os.psyverse.fun","civos-clan-civilization.psyverse.fun","civos-idea-evolution.psyverse.fun","civos-material-civilization.psyverse.fun","civos.psyverse.fun","civtech.psyverse.fun","clan-civilization.psyverse.fun","clarity-os.psyverse.fun","climate-civilization.psyverse.fun","cnkol.psyverse.fun","coders.psyverse.fun","cognition-gym.psyverse.fun","cognitive-civilization.psyverse.fun","collapse-watch.psyverse.fun","convergence.psyverse.fun","cosmos-to-code.psyverse.fun","creators.psyverse.fun","cryptocivilization.psyverse.fun","cycle-engine.psyverse.fun","dance.psyverse.fun","daofaziran.psyverse.fun","decision-os.psyverse.fun","desire-atlas.psyverse.fun","digital-species.psyverse.fun","dongbei-renaissance.psyverse.fun","dream-foundry.psyverse.fun","elements-of-civilization.psyverse.fun","emotion-os.psyverse.fun","ethics-engine.psyverse.fun","evolution-of-eyes.psyverse.fun","evolution.psyverse.fun","failure-museum.psyverse.fun","figures.psyverse.fun","five-challenges.psyverse.fun","five-worlds.psyverse.fun","four-primitives.psyverse.fun","frontier-garrisons.psyverse.fun","fusion-os.psyverse.fun","future-economy.psyverse.fun","future-energy-dashboard.psyverse.fun","future-materials-database.psyverse.fun","future-simulator.psyverse.fun","ge.psyverse.fun","gear.psyverse.fun","global-materials-graph.psyverse.fun","gosu.psyverse.fun","grassland.psyverse.fun","greatest-ideas.psyverse.fun","haplo.psyverse.fun","heat.psyverse.fun","highway.psyverse.fun","how-the-world-works.psyverse.fun","huangqihai-civilization.psyverse.fun","hub.psyverse.fun","human-future-atlas.psyverse.fun","human-memory-project.psyverse.fun","human-os.psyverse.fun","humanity-os.psyverse.fun","humanity-problem-database.psyverse.fun","humanoids.psyverse.fun","idc.psyverse.fun","idea-evolution.psyverse.fun","ideaspace.psyverse.fun","ides.psyverse.fun","influence-os.psyverse.fun","inner-monologue.psyverse.fun","innovators.psyverse.fun","insights.psyverse.fun","intelligence-network.psyverse.fun","internet-tribes.psyverse.fun","invisible-systems.psyverse.fun","island.psyverse.fun","jin-atlas.psyverse.fun","knowledge-compression-engine.psyverse.fun","knowledge-os.psyverse.fun","kol.psyverse.fun","langbrain.psyverse.fun","last-seen.psyverse.fun","learn.psyverse.fun","ledger.psyverse.fun","levels.psyverse.fun","libertarian.psyverse.fun","life-cinematic.psyverse.fun","life-os.psyverse.fun","links.psyverse.fun","llms.psyverse.fun","manifesto.psyverse.fun","market.psyverse.fun","mask-engine.psyverse.fun","material-civilization.psyverse.fun","meaning.psyverse.fun","memory-atlas.psyverse.fun","mind-arena.psyverse.fun","mindatlas.psyverse.fun","mindforge.psyverse.fun","minds.psyverse.fun","mindseye.psyverse.fun","mirror.psyverse.fun","mountain-merchants.psyverse.fun","names.psyverse.fun","neolithic-world.psyverse.fun","north-rules-south.psyverse.fun","oceanic-civilization.psyverse.fun","omega.psyverse.fun","org.psyverse.fun","oss.psyverse.fun","pacific-rim-ports.psyverse.fun","parallel-life.psyverse.fun","parenting-os.psyverse.fun","persona-engine.psyverse.fun","privacy.psyverse.fun","prompts.psyverse.fun","psy-civilization.psyverse.fun","psy-killer-apps.psyverse.fun","psy-protocol-spec.psyverse.fun","psy-spec.psyverse.fun","psy.psyverse.fun","psyverse-os.psyverse.fun","quantum-computing-visualizer.psyverse.fun","quantum.psyverse.fun","reality-engine.psyverse.fun","reality-kernel.psyverse.fun","reality-simulation-engine.psyverse.fun","reality.psyverse.fun","regions.psyverse.fun","researchers.psyverse.fun","roads.psyverse.fun","robot-civilization-observatory.psyverse.fun","saas.psyverse.fun","seeker.psyverse.fun","self-construction-os.psyverse.fun","sensory-os.psyverse.fun","sentience.psyverse.fun","signal.psyverse.fun","sim.psyverse.fun","sinosphere.psyverse.fun","skills.psyverse.fun","social-temperature.psyverse.fun","southward-migration.psyverse.fun","staples.psyverse.fun","states-of-reality.psyverse.fun","steppe-empire.psyverse.fun","store.psyverse.fun","strategy-os.psyverse.fun","string.psyverse.fun","surnames.psyverse.fun","survival-intelligence.psyverse.fun","suyu.psyverse.fun","synthetic-history.psyverse.fun","tao.psyverse.fun","tech.psyverse.fun","techne.psyverse.fun","the-human-library.psyverse.fun","time.psyverse.fun","tools.psyverse.fun","triangle.psyverse.fun","truth.psyverse.fun","uncertainty-os.psyverse.fun","urcde.psyverse.fun","value-planes.psyverse.fun","warp.psyverse.fun","wiki.psyverse.fun","yellow-river-frontier.psyverse.fun","zk-civilization.psyverse.fun"];
